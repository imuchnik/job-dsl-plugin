<<<<<<< HEAD
The job reference has been moved to the [API Viewer](https://jenkinsci.github.io/job-dsl-plugin/).
=======
...
freeStyleJob(String name) { // since 1.30
    ...
    wrappers { // since 1.19, before that the methods were on top level
        ...
        sauceOnDemandConfig(Closure sauceOnDemandConfig} //since 1.39
    }
...
(since 1.29)
>>>>>>> Adding sauce on demand support
